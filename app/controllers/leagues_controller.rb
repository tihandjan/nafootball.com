  ...
  def fixtures
    ...
    if params[:id] == 'seria-a'
      ...
      set_meta_tags title: "Чемпионат Англии по футболу, расписание матчей",
                    ...
                    keywords: "Футбол, спорт, новости, сегодня, трансферы, слухи, повторы, онлайн, смотреть, результаты, расписание, календарь, uefa, превью, лига чемпионов, роналду, месси, манчестер, юнайтед, бавария, реал, барселона, челси, арсенал, ливерпуль, ювентус, сити"
    end
  end
